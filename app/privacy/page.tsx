  ...
  return (
    ...
    >
      <section className="privacy-list">
        ...
        <article><h2>Authorization and consent record</h2><p>Live plans require an authenticated operator and exact server allowlist match, then store the consent attestation and authorized calling window. Possessing or submitting a number never grants call authority.</p></article>
