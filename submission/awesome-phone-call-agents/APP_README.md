...
The live selector stays disabled unless mode, API key, and approval secret are all present. A live plan must still be valid, unexpired, submitted with `approved: true`, and bound to the reviewed request.
