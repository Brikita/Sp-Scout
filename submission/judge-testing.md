...
5. Select **Review supplier call plan**. This prepares and signs a fixture plan but cannot place a call.
...
10. Visit **Pilot evidence** and confirm that fixture results are excluded from live metrics.
11. Visit **The project** and **Safety** to review the architecture, current evidence boundary and calling controls.

## What the safe demo proves

- The same validated request and strict schemas used by the live adapter.
- Plan signing, expiry, masked recipients, explicit approval, result normalization, confidence treatment and evidence display.
- Localized-market behavior and a complete public product experience.
...
No live test should be inferred from these instructions. It requires a consenting number in a currently supported recipient/language combination, a recorded authorized calling window, an exact call goal and explicit approval for that specific run. The public Vercel fixture does not provide D1-backed history.
